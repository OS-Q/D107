...
#define TFT_RST 16   //for TFT I2C Connector Shield (V1.1.0 or later)
#define TFT_CS 4    //for TFT I2C Connector Shield (V1.1.0 or later)
#define TFT_DC 5    //for TFT I2C Connector Shield (V1.1.0 or later)
